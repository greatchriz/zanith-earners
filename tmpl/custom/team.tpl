...
<!-- Start Hero -->
<section
    class="relative table w-full py-36 lg:py-44 bg-[url('../../assets/images/team.jpg')] bg-no-repeat bg-center bg-cover"
>
    <div class="absolute inset-0 bg-black opacity-75"></div>
    <div class="container relative">
        <div class="grid grid-cols-1 pb-8 text-center mt-10">
            <h3 class="mb-6 md:text-4xl text-3xl md:leading-normal leading-normal font-medium text-white">Team
                Member</h3>
...
<section class="relative md:py-24 py-16">
            ...
            <div class="lg:col-span-7 md:col-span-6">
                <div class="lg:ms-5">
                    ...
                    <p class="text-slate-400 max-w-xl">Start working with Tailwind CSS that can provide
                        ...
                        will later be filled with 'real' content.</p>
    ...
    <div class="container relative md:mt-24 mt-16">
        <div class="grid grid-cols-1 pb-8 text-center">
            <h3 class="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Our
        ...
        <div class="grid md:grid-cols-12 grid-cols-1 items-center mt-8 gap-[30px]">
            ...
            <div class="lg:col-span-3 md:col-span-6">
                <div
                    class="team p-6 rounded-md shadow-md dark:shadow-gray-800 dark:border-gray-700 bg-white dark:bg-slate-900 relative">
                    <div
                        class="absolute inset-0 bg-emerald-600/10 dark:bg-emerald-600/30 rounded-md -mt-[10px] -ms-[10px] h-[98%] w-[98%] -z-1">
                    </div>
                    <img
                    ...
                    <div class="content mt-4">
                        <a
                            href=""
                            class="text-lg font-medium hover:text-emerald-600 block"
                        >Aliana Rosy</a>
            ...
            <div class="lg:col-span-3 md:col-span-6">
                <div
                    class="team p-6 rounded-md shadow-md dark:shadow-gray-800 dark:border-gray-700 bg-white dark:bg-slate-900 relative">
                    <div
                        class="absolute inset-0 bg-red-600/10 dark:bg-red-600/30 rounded-md -mt-[10px] -ms-[10px] h-[98%] w-[98%] -z-1">
                    </div>
                    <img
                    ...
                    <div class="content mt-4">
                        <a
                            href=""
                            class="text-lg font-medium hover:text-red-600 block"
                        >Sofia Razaq</a>
                        ...
                        <ul class="list-none mt-4">
                            <li class="inline"><a
                                    href=""
                                    class="btn btn-icon btn-sm border border-gray-100 dark:border-gray-800 rounded-md hover:border-red-600 hover:bg-red-600 hover:text-white"
                                ><i
                                        data-feather="facebook"
                                        class="h-4 w-4"
                                    ></i></a></li>
            ...
            <div class="lg:col-span-3 md:col-span-6">
                <div
                    class="team p-6 rounded-md shadow-md dark:shadow-gray-800 dark:border-gray-700 bg-white dark:bg-slate-900 relative">
                    <div
                        class="absolute inset-0 bg-sky-600/10 dark:bg-sky-600/30 rounded-md -mt-[10px] -ms-[10px] h-[98%] w-[98%] -z-1">
                    </div>
                    <img
                    ...
                    <div class="content mt-4">
                        <a
                            href=""
                            class="text-lg font-medium hover:text-sky-600 block"
                        >Micheal Carlo</a>
                        ...
                        <ul class="list-none mt-4">
                            <li class="inline"><a
                                    href=""
                                    class="btn btn-icon btn-sm border border-gray-100 dark:border-gray-800 rounded-md hover:border-sky-600 hover:bg-sky-600 hover:text-white"
                                ><i
                                        data-feather="facebook"
                                        class="h-4 w-4"
                                    ></i></a></li>
