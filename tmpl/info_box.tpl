			...
			{if $stat_last_adfunds}
				<tr>
					...
					<td
						class=menutxt
						align=right
					>{$currency_sign} {$stat_last_addfunds.amount|number_format:2}
						({$stat_last_adfunds.username})</td>
				</tr>
			{/if}
		{/if}
			...
			{if $stat_last_deposit}
				<tr>
					...
					<td
						class=menutxt
						align=right
					>{$currency_sign} {$stat_last_deposit.amount|number_format:2}
						({$stat_last_deposit.username})</td>
				</tr>
			{/if}
		{/if}
			...
			{if $stat_last_withdrawal}
				<tr>
					...
					<td
						class=menutxt
						align=right
					>{$currency_sign} {$stat_last_withdrawal.amount|number_format:2}
						({$stat_last_withdrawal.username})</td>
				</tr>
			{/if}
		{/if}
