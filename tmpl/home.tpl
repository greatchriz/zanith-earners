...
<!-- Start Hero -->
<section
    class="relative table w-full py-52 md:py-64 bg-[url('../../assets/images/crypto/bg1.jpg')] bg-center bg-no-repeat bg-cover"
>
    <div class="container">
        <div class="grid grid-cols-1">
            <h5 class="font-normal text-lg text-white/50 mb-3">Pay with <span
                    class="typewrite text-white"
                    data-period="2000"
                    data-type='[ "Crypto", "ETH", "BNB", "SOL", "DOT", "NEAR", "CEL" ]'
                > <span class="wrap"></span> </span></h5>
            <h4 class="text-white font-semibold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5">
                Building the future <br> of Crypto Revolution.</h4>
            <p class="text-white/70 max-w-xl mb-0">Take full control of your cryptocurrencies and collectibles
            ...
            <div class="subcribe-form mt-6 mb-4">
                <form class="relative max-w-xl">
                    <input
                        ...
                        id="subcribe"
                        name="email"
                        class="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none dark:text-white rounded-full bg-white/5 shadow border border-slate-900 text-white"
                        placeholder="Your Email Address :"
                    >
                    <button
                        type="submit"
                        class="btn absolute top-[2px] end-[3px] h-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full"
                    >Register Now <i class="uil uil-arrow-right"></i></button>
                </form>
                <!--end form-->
            </div>

            <span class="text-white">Looking for help? <a
                    href=""
                    class="text-amber-500"
                >Get in touch with us</a></span>
        </div>
    </div>
</section>
<!--end section-->
...
<section class="relative md:py-24 py-16">
    <div class="container">
        <div class="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
            <div class="lg:col-span-5">
                <img
                    src="assets/images/crypto/01.png"
                    alt=""
                >
            </div>
            <div class="lg:col-span-7 mt-8 md:mt-0">
                <div class="lg:ms-10">
                    ...
                    <h3 class="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Buy
                        Cryptocurrency <br> with Techwind</h3>
                    <p class="text-slate-400 max-w-xl">You can combine all the Techwind templates into a single
    ...
    <div class="container md:mt-24 mt-16">
        <div class="grid grid-cols-1 pb-8 text-center">
            <h3 class="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">We featured on
                popular partners like</h3>
        </div>
        <!--end grid-->
...
<section class="relative md:py-24 py-16 bg-[url('../../assets/images/crypto/bg2.jpg')] bg-center bg-no-repeat bg-cover">
    ...
    <div class="container">
        <div class="grid grid-cols-1 pb-8 text-center">
            <h3 class="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-medium text-white">Our
                Benefits</h3>

            <p class="text-white/70 max-w-xl mx-auto">Start working with Tailwind CSS that can provide
...
<section class="relative md:py-24 py-16 md:pb-0 pb-0">
            ...
            <div class="lg:col-span-5 md:col-span-6 order-2 md:order-1">
                <div class="shadow dark:shadow-gray-800 rounded-md p-6 bg-gray-50 dark:bg-slate-800 overflow-hidden">
                    ...
                    <p class="text-slate-400 text-center mt-8">Token sale ends <span
                            class="text-dark font-semibold">August 25th 2022</span></p>
                    ...
                    <ul class="list-none mt-4">
                        <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl me-2"></i>
                            <span class="text-slate-400">Soft Cap:</span> &nbsp;10000 USD
                        </li>
                        <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl me-2"></i>
                            <span class="text-slate-400">Min. transaction Amount:</span> &nbsp;1000 USD
                        </li>
                        <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl me-2"></i>
                            <span class="text-slate-400">Target:</span> &nbsp;900000 USD
                        </li>
                    </ul>
            ...
            <div class="lg:col-span-7 md:col-span-6 order-1 md:order-2">
                <div class="lg:ms-10">
                    <span class="bg-indigo-600/5 text-indigo-600 text-xs font-bold px-2.5 py-0.5 rounded h-5">Sale
                        tokens</span>
                    <h4 class="my-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">The
                        token sale is live!</h4>
                    <p class="text-slate-400 para-desc mx-auto mb-3">With Techwind Trade, you can be sure your
                        trading skills are matched with excellent service.</p>
                    <p class="text-slate-400 para-desc mx-auto">Techwind Institutional Markets is a full-stack
                        crypto services platform that works with crypto-native businesses and institutional
                        clients on lending, trading, and custody solutions tailored to your needs.</p>
                    <div class="mt-4">
                        <a
                            href=""
                        ...
                        <a
                            ...
                            data-type="youtube"
                            data-id="yba7hPeTSjk"
                            class="btn btn-icon rounded-full bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white m-1 lightbox"
                        ><i
                                data-feather="video"
                                class="h-4 w-4"
                            ></i></a><span class="font-semibold ms-1 align-middle">Watch Now</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container md:mt-24 mt-16">
        <div class="grid grid-cols-1 pb-8 text-center">
            <h3 class="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">All your crypto
                and NFTs in one place</h3>

            <p class="text-slate-400 max-w-xl mx-auto">With Techwind Trade, you can be sure your trading skills
                are matched with excellent service.</p>
        </div>
        <!--end grid-->
    ...
    <div class="container md:mt-24 mt-16">
        <div class="grid md:grid-cols-2 grid-cols-1 gap-[30px] lg:items-center items-end">
            <div class="mb-8">
                ...
                <p class="text-slate-400 max-w-xl mx-auto">With Techwind Trade, you can be sure your trading
                ...
                <ul class="list-none">
                    ...
                    <li class="flex mt-6">
                        ...
                        <div class="flex-1 ms-3">
                            ...
                            <p class="text-slate-400 mt-1">Rest assured you (and only you) have access to your
                                funds</p>
                        </div>
                    </li>
                </ul>
    ...
    <div class="container">
        <div class="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1">
            <div class="text-center">
                ...
                <h2 class="mb-0 text-4xl mt-3 font-bold text-indigo-600"><span
                        class="counter-value"
                        data-target="2021"
                    >1990</span></h2>
            </div>
...
<section class="relative md:py-24 py-16">
    <div class="container">
        <div class="grid grid-cols-1 pb-8 text-center">
            <h3 class="mb-6 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">What our
                customer <br> say about us</h3>
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
            <div class="flex">
                <i
                    ...
                    class="fea icon-ex-md text-indigo-600 me-3"
                ></i>
                <div class="flex-1">
                    <h5 class="mb-2 text-xl font-semibold">How our <span class="text-indigo-600">Techwind</span>
                        work ?</h5>
            ...
            <div class="flex">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-slate-400">If the distribution of letters and 'words' is random, the reader
                        will not be distracted from making a neutral judgement on the visual impact</p>
                </div>
            </div>
            ...
            <div class="flex">
                ...
                ></i>
                <div class="flex-1">
                    <h5 class="mb-2 text-xl font-semibold"> Is <span class="text-indigo-600">Techwind</span>
                        safer to use with my account ?</h5>
